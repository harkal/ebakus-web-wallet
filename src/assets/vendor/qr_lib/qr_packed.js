  ...
  qrcode: (function() {
    ...
    function w(a, b) {
      ...
      this.addOrSubtract = function(c) {
        ...
        for (
          var b = Array(c.length), e = c.length - d.length, h = 0;
          h < e;
          h++
        )
          b[h] = c[h]
    ...
    function S() {
      ...
      this.selectBestPatterns = function() {
        ...
        if (3 > a)
          throw "Couldn't find enough finder patterns (found " + a + ')'
        if (3 < a) {
    ...
    function X(a, b, e) {
      ...
      this.getNextBits = function(b) {
        ...
        if (b < this.bitPointer + 1 + 8) {
          ...
          d =
            (this.blocks[this.blockPointer] & c) << (b - (this.bitPointer + 1))
          this.blockPointer++
          d +=
    ...
    E.rsDecoder = new function(a) {
      ...
      this.decode = function(a, e) {
        for (
          var b = new w(this.field, a), c = Array(e), f = 0;
          f < c.length;
          f++
        )
          c[f] = 0
